/**
 * @file Ellipse.cpp
 * @brief Implementation of the Ellipse class using Midpoint Ellipse Algorithm.
 * 
 * Renders ellipses (ovals) with two radii using an efficient algorithm
 * adapted from the midpoint circle algorithm.
 */
