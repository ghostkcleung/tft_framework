/**
 * @file Font5X7.cpp
 * @brief Implementation of the default 5×7 pixel matrix font.
 * 
 * Renders text using a built-in 5×7 pixel font stored in PROGMEM.
 * Each character is defined as a 5-byte array representing the pixel matrix.
