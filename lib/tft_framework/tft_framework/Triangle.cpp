/**
 * @file Triangle.cpp
 * @brief Implementation of the Triangle class for three-sided polygons.
 * 
 * Triangles are drawn as three connected lines for the outline,
 * or filled using a scanline algorithm for solid triangles.
 */
...
void Triangle::setP2(int16_t x, int16_t y) { this->p2.setPoint(x, y); }

void Triangle::setP3(Point p3) { this->p3 = p3; }

void Triangle::setP3(int16_t x, int16_t y) { this->p3.setPoint(x, y); }
