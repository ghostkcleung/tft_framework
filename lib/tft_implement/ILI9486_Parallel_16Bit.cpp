...
void ILI9486_Parallel_16Bit::init() {
	...
	// ?????
	{
		uint8_t datas[] = {0x1C, 0xA3, 0x32, 0x02, 0xb2,
						   0x12, 0xFF, 0x12, 0x00};
	...
	{
		uint8_t datas[] = {0x0f, 0x24, 0x1c, 0x0a, 0x0f, 0x08, 0x43, 0x88,
	...
	{
		uint8_t datas[] = {0x0F, 0x38, 0x30, 0x09, 0x0f, 0x0f, 0x4e, 0x77,
	...
	// Column Addess Set
	{
		uint8_t datas[] = {0x00, 0x00, 0x01, 0xDF};
	...
	// Page Address Set
	{
		uint8_t datas[] = {0x00, 0x00, 0x01, 0x3F};
