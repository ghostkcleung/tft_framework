...
void Mega2560_ILI9486_16Bit::setDirectionRegisters(){
	DDRA = 0xFF ;
    DDRC = 0xFF ;
}

Mega2560_ILI9486_16Bit::Mega2560_ILI9486_16Bit(int16_t w, int16_t h,
...
void Mega2560_ILI9486_16Bit::cbi ( RegType *port, RegSize bitmask )
{
    *port &= ~bitmask ;
}

void Mega2560_ILI9486_16Bit::sbi ( RegType *port, RegSize bitmask )
{
    *port |= bitmask ;
}

void Mega2560_ILI9486_16Bit::pulseHigh ( RegType *port, RegSize bitmask )
{
    sbi ( port, bitmask ) ;
    cbi ( port, bitmask ) ;
}

void Mega2560_ILI9486_16Bit::pulseLow ( RegType *port, RegSize bitmask )
{
    cbi ( port, bitmask ) ;
    sbi ( port, bitmask ) ;
}

void Mega2560_ILI9486_16Bit::writeCom ( uint8_t com )
{
...
void Mega2560_ILI9486_16Bit::writeData ( uint8_t data )
{
...
void Mega2560_ILI9486_16Bit::init()
{
	setDirectionRegisters();
...
void Mega2560_ILI9486_16Bit::setWindow ( Rectangle* r )
{
    int16_t x1 = r -> getX(),
            y1 = r -> getY(),
            x2 = r -> getEndX(),
...
void Mega2560_ILI9486_16Bit::feedValue ( uint8_t h, uint8_t l ) {
    PORTA = h;
    PORTC = l ;
}

void Mega2560_ILI9486_16Bit::fillRect ( Rectangle* r )
{
	setWindow ( r );
...
void Mega2560_ILI9486_16Bit::setRotate(uint8_t rotate)
{
    rotate %= 4;
    if (getRotate()==rotate)
    {
...
void Mega2560_ILI9486_16Bit::fillImpl(BufferScreen* buf)
{
