...
void ILI9486_Parallel::setDirectionRegisters(){
...
void ILI9486_Parallel::writeCom ( uint8_t com )
{
    writeCom ( com, NULL, 0 ) ;
}

void ILI9486_Parallel::writeCom ( uint8_t com, uint8_t data )
{
	uint8_t datas[] = { data } ;
    writeCom ( com, datas, 1 ) ;
}

void ILI9486_Parallel::writeCom ( uint8_t com, uint8_t *datas, unsigned int count ){
...
void ILI9486_Parallel::writeCom16 ( uint8_t com, uint16_t data ) {
	uint8_t datas[] = { data >> 8, data } ;
    writeCom ( com, datas, 2 ) ;
}
...
void ILI9486_Parallel::init()
{
    ...
    writeCom( 0xF2, datas, sizeof ( datas ) );	}
    ...
    writeCom( 0xB6, datas, sizeof ( datas ) );	}
    ...
    writeCom( 0xE0, datas, sizeof ( datas ) );	}
    ...
    writeCom( 0xE1, datas, sizeof ( datas ) );	}
    ...
    writeCom( 0x2A, datas, sizeof ( datas ) );	}

	// Page Address Set
	{ uint8_t datas[] = {
		0x00, 0x00, 0x01, 0x3F } ;

    writeCom( 0x2B, datas, sizeof ( datas ) );	}
...
void ILI9486_Parallel::setWindow ( Rectangle* r )
{
	...
	writeCom ( 0x2A, datas, 4 ) ; }

	{ uint8_t datas[] = { y1 >> 8, y1, y2 >> 8, y2 } ;
	writeCom ( 0x2B, datas, 4 ) ; }
