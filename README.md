...
But be attention for the limitation of memory size. It need 2byte per pixel. There is 8k byte inside the Arduino Mega 2560. That means the maxium bounds of buf can be about 60x60 only.
60x60x2 = 7200bytes
